...
<h1 class="text">How does the scoring algorithm work?</h1>
<p class="text">Every game, the winner takes 2 points plus 1 additional points for the goal difference. So, 1-0 adds 3 points to your Leaderboard Score, 2-0 adds 4, and 2-1 again adds 3. Of course these point will have to come from somewhere: the loser will lose Leaderboard Score at the same rate.</p><br>
...
<p class="text">A: You can play anytime, anywhere. Once you've played a match, select ADD RESULTS from the menu and make your result public. For results to become official, you will need to enter both your own and your opponent's password!</p>
<br><br>
