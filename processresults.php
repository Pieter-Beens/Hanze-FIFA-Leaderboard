...
if (isset($_POST['awayplayer'])) { // will bind POST vars from last page to global SESSION vars once upon first loading the page, needed because this page will reload
	$_SESSION['awayplayer'] = $_POST['awayplayer'];
	$_SESSION["homegoals"] = $_POST["homegoals"];
	$_SESSION["awaygoals"] = $_POST["awaygoals"];
	$_SESSION["description"] = $_POST["description"];
}
if (!isset($_SESSION['awayplayer'])) { // should only happen when results have been sent already
	die ('ERROR: Did you try to refresh the page after confirming your results? Stop trying to cheat!');
};
